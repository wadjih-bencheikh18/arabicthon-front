...
export function ChoiceTa2lif() {
  ...
  const functionalities = [
    ...
    {
      short: "إكمال البيت",
      long: "إكمال البيت بناء على بحر و حرف الروي",
      link: "/ikmalKalima",
    },
  ];
  return (
    <div className="h-screen flex flex-col justify-end items-end p-16">
      ...
      <div className="flex justify-end items-center">
        ...
        {/* cards container */}
        <div className="flex flex-wrap flex-row-reverse h-[31.5rem] 2xl:w-[54rem]  w-[50rem] mx-20 overflow-y-scroll items-center px-5 pt-4">
